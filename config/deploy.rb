...
set :user, 'demo'
set :keep_releases, 3 
set :repository,  "git@github.com:benhall2121/athletePreneur.git" # replace neerajdotname with your github username
set :use_sudo, false
set :scm, :git
set :deploy_via, :copy
...
set :application, 'athletePreneur' # replace gitlearn with your application name
